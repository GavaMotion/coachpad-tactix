...
// Higher x = right side of pitch, lower x = left side of pitch (from player's perspective)
...
const F_8U_21 = {
  ...
  slots: [
    ...
    { id: 'def1', label: 'LB', x: 33, y: 65 },
    { id: 'def2', label: 'RB', x: 67, y: 65 },
...
const F_10U_231 = {
  ...
  slots: [
    ...
    { id: 'def1', label: 'LB', x: 33, y: 72 },
    { id: 'def2', label: 'RB', x: 67, y: 72 },
    { id: 'mid1', label: 'LM', x: 25, y: 51 },
    { id: 'mid2', label: 'CM', x: 50, y: 51 },
    { id: 'mid3', label: 'RM', x: 75, y: 51 },
...
const F_10U_321 = {
  ...
  slots: [
    { id: 'gk',   label: 'GK', x: 50, y: 89 },
    { id: 'def1', label: 'LB', x: 25, y: 72 },
    { id: 'def2', label: 'CB', x: 50, y: 72 },
    { id: 'def3', label: 'RB', x: 75, y: 72 },
...
const F_12U_332 = {
  ...
  slots: [
    ...
    { id: 'mid1', label: 'LM', x: 25, y: 53 },
    { id: 'mid2', label: 'CM', x: 50, y: 53 },
    { id: 'mid3', label: 'RM', x: 75, y: 53 },
...
const F_12U_323 = {
  ...
  slots: [
    ...
    { id: 'fwd1', label: 'LW', x: 25, y: 23 },
    { id: 'fwd2', label: 'ST', x: 50, y: 23 },
    { id: 'fwd3', label: 'RW', x: 75, y: 23 },
  ],
}
...
const F_12U_422 = {
  ...
  slots: [
    { id: 'gk',   label: 'GK', x: 50, y: 90 },
    { id: 'def1', label: 'LB', x: 20, y: 74 },
    { id: 'def2', label: 'CB', x: 40, y: 74 },
    { id: 'def3', label: 'CB', x: 60, y: 74 },
    { id: 'def4', label: 'RB', x: 80, y: 74 },
    { id: 'mid1', label: 'CM', x: 33, y: 53 },
    { id: 'mid2', label: 'CM', x: 67, y: 53 },
    { id: 'fwd1', label: 'ST', x: 33, y: 23 },
    { id: 'fwd2', label: 'ST', x: 67, y: 23 },
...
const F_12U_242 = {
  ...
  slots: [
    { id: 'gk',   label: 'GK', x: 50, y: 90 },
    { id: 'def1', label: 'LB', x: 33, y: 74 },
    { id: 'def2', label: 'RB', x: 67, y: 74 },
    { id: 'mid1', label: 'LM', x: 20, y: 53 },
    { id: 'mid2', label: 'CM', x: 40, y: 53 },
    { id: 'mid3', label: 'CM', x: 60, y: 53 },
    { id: 'mid4', label: 'RM', x: 80, y: 53 },
    { id: 'fwd1', label: 'ST', x: 33, y: 23 },
    { id: 'fwd2', label: 'ST', x: 67, y: 23 },
  ],
}
...
const F_11V11_442 = {
  ...
  slots: [
    ...
    { id: 'def3', label: 'CB',  x: 60, y: 76 },
    { id: 'def4', label: 'RB',  x: 80, y: 76 },
    { id: 'mid1', label: 'LM',  x: 20, y: 55 },
    { id: 'mid2', label: 'CM',  x: 40, y: 55 },
    { id: 'mid3', label: 'CM',  x: 60, y: 55 },
    { id: 'mid4', label: 'RM',  x: 80, y: 55 },
...
const F_11V11_4231 = {
  ...
  slots: [
    ...
    { id: 'att1', label: 'LM',  x: 25, y: 44 },
    { id: 'att2', label: 'CAM', x: 50, y: 44 },
    { id: 'att3', label: 'RM',  x: 75, y: 44 },
    { id: 'fwd1', label: 'ST',  x: 50, y: 22 },
  ],
}
...
const F_11V11_4411 = {
  ...
  slots: [
    ...
    { id: 'def3', label: 'CB',  x: 60, y: 76 },
    { id: 'def4', label: 'RB',  x: 80, y: 76 },
    { id: 'mid1', label: 'LM',  x: 20, y: 58 },
    { id: 'mid2', label: 'CM',  x: 40, y: 58 },
    { id: 'mid3', label: 'CM',  x: 60, y: 58 },
    { id: 'mid4', label: 'RM',  x: 80, y: 58 },
