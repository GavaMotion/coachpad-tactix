...
export const DRILLS = [
  ...
  },
  {
    ...
    difficulty: 'Medium',
    phase: 'warm-up',
    description: 'Five players on the outside keep the ball away from two defenders in the middle. The classic possession warm-up used at every level of the game. Simple rules — maximum learning.',
    coachingPoints: [
      'Move after every pass — find a fresh angle immediately',
      'Pass to the player with the most space, not the nearest one',
      'Use body shape and feints to open passing lanes',
      'Defenders: work as a pair — one presses, one covers',
      'Change the speed — slow when safe, fast when pressed',
    ],
    variations: [
      'Two-touch maximum',
      'One-touch only for advanced groups',
      'Adjust numbers — 4v2 for harder, 6v2 for easier',
    ],
  },
  {
    id: 'drill_new_014',
